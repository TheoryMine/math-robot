...
sig
  ...
  structure Fn : sig include SSTR_NAME; val default_constr_name : name end
  (* type names: elements/arguments in a constructor *)
  structure Tn : SSTR_NAME 
  (* names for variables *)
  structure Vn : SSTR_NAME
...
functor TM_Types(N : SSTR_NAME) : TM_TYPES = 
struct
  ...
  (* type names: elements/arguments in a constructor *)
  structure Tn : SSTR_NAME = struct open N; val default_name = N.mk "T_1"; end;
  (* names for variables *)
  structure Vn : SSTR_NAME = struct open N; val default_name = N.mk "x_1"; end;
